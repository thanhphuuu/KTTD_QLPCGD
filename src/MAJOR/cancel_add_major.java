...
public class cancel_add_major {
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);
        //mã ngành
        driver.findElement(By.id("id")).sendKeys("sss111");
        Thread.sleep(2000);
        //tên ngành
        driver.findElement(By.id("name")).sendKeys("Công nghệ thông tin");
        Thread.sleep(2000);
        //tên viết tắt
        driver.findElement(By.xpath("/html/body/div[3]/div[2]/form/div[3]/input")).sendKeys("CNTT1");
        Thread.sleep(2000);
        //CHỌN ctdt
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("/html/body/div[4]/div[2]/form/div[5]/button[1]")).click();
	}
}
