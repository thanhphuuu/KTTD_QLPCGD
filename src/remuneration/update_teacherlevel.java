...
public class update_teacherlevel {
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);
        //chọn update
        driver.findElement(By.xpath("/html/body/div[3]/div[2]/form/div[3]/div/span/span[1]/span")).click();
        Thread.sleep(2000);
      //chọn update
        driver.findElement(By.xpath("/html/body/div[3]/div[2]/form/div[3]/div/span[2]/span/span[2]/ul/li[211]")).click();
        Thread.sleep(2000);
        //save
