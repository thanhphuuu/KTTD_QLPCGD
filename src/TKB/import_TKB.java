...
public class import_TKB {
    public static void main(String[] args) throws InterruptedException, AWTException {
        ...
        Thread.sleep(2000);
        // Chọn học kỳ
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[1]/div/div/div[2]/form/div[1]/div[1]/div/span/span[1]/span/span[1]")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[1]/div/div/div[2]/form/div[1]/div[1]/div/span[2]/span/span[2]/ul/li[4]")).click();
        Thread.sleep(2000);
        //chọ ngành
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[1]/div/div/div[2]/form/div[1]/div[2]/div/span/span[1]/span/span[1]")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[1]/div/div/div[2]/form/div[1]/div[2]/div/span[2]/span/span[2]/ul/li[3]")).click();
        Thread.sleep(2000);
        //chọn import
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[1]/div/div/div[2]/form/div[2]")).click();
        Thread.sleep(2000);
        // Gọi phương thức robot để thực hiện việc dán đường dẫn tệp tin
        StringSelection ss = new StringSelection("D:\\CNTT_UIS.xlsx");
        Toolkit.getDefaultToolkit().getSystemClipboard().setContents(ss, null);
        Thread.sleep(2000);
        
        // Khởi tạo một đối tượng Robot
        Robot robot = new Robot();
        
        // Nhấn phím CONTROL + V để dán đường dẫn tệp tin
