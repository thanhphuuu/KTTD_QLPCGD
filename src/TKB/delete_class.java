...
public class delete_class {
	public static void main(String[] args) throws InterruptedException, AWTException {
        ...
        Thread.sleep(2000);
        // Chọn môn học muốn xóa
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div[2]/div[3]/table/tbody/tr[3]/td[12]/div/button")).click();
        Thread.sleep(2000);
        // Chọn icon xóa
        driver.findElement(By.xpath("/html/body/div[3]/div[2]/div/button[2]")).click();
        Thread.sleep(2000);
        // nhập lại mã để xác nhận
        driver.findElement(By.xpath("/html/body/div[4]/div/input[1]")).sendKeys("221_71ITBS10203_0501");
        Thread.sleep(2000);
        // xác nhận xóa
        driver.findElement(By.cssSelector("body > div.swal2-container.swal2-center.swal2-backdrop-show > div > div.swal2-actions > button.swal2-confirm.btn.btn-primary")).click();
