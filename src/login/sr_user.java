...
public class sr_user {
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);
        //nhập tên muốn tìm vào ô tìm kiếm
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[2]/div[2]/div/div/div[1]/div[2]/div/div[1]/div/label/input")).sendKeys("2174802010569");
        Thread.sleep(2000);
        //so sánh
        WebElement statisticElement = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[2]/div[2]/div/div/table/tbody/tr/td[2]"));

        // Lấy nội dung thống kê
        String actualStatistic = statisticElement.getText();

        // Kết quả mong đợi
        String expectedStatistic = "2174802010569";

        // So sánh kết quả thực tế và kết quả mong đợi
        if (actualStatistic.equals(expectedStatistic)) {
            System.out.println("Kết quả thống kê chính xác!");
        } else {
            System.out.println("Kết quả thống kê không chính xác! " + "kết quả thực tế là: " + actualStatistic);
        }
        // Đóng trình duyệt
        driver.quit();
	}
