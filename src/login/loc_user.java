...
public class loc_user {
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);
        //chọn vào chức năng người dùng
        driver.findElement(By.xpath("/html/body/div[2]/div[1]/div[2]/ul/li[3]/a")).click();
        Thread.sleep(2000);
        //chọn vào lọc loại GV
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[2]/div[1]/div[2]/div[1]/select")).click();
        Thread.sleep(2000);
        // chọn cơ hữu
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[2]/div[1]/div[2]/div[1]/select/option[2]")).click();
        Thread.sleep(2000);
        // chọn vào lọc role
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[2]/div[1]/div[2]/div[2]/select")).click();
        Thread.sleep(2000);
        //chọn bộ môn
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div[2]/div[1]/div[2]/div[2]/select/option[3]")).click();
        Thread.sleep(2000);
        driver.quit();
	}
}
