...
public class cancel_add_user {
	public static void main(String[] args) throws InterruptedException {
        ...
        //nhập mã số
        driver.findElement(By.xpath("/html/body/div[3]/div[2]/form/div[1]/input")).sendKeys("4564564356456");
        Thread.sleep(1000);
        //nhập tên
        driver.findElement(By.xpath("/html/body/div[3]/div[2]/form/div[2]/input")).sendKeys("Nguyễn văn A");
        Thread.sleep(1000);
        //nhập email
        driver.findElement(By.xpath("/html/body/div[3]/div[2]/form/div[3]/input")).sendKeys("a2342@vanlanguni.vn");
        Thread.sleep(1000);
