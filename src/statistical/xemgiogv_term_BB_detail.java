...
public class xemgiogv_term_BB_detail {
	public static void main(String[] args) throws InterruptedException, AWTException {
        ...
        Thread.sleep(2000);
        // Chọn icon dấu cộng để xem chi tiết
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div[2]/div[2]/div[2]/div[2]/div/div/table/tbody/tr[1]/td[2]/button")).click();
        Thread.sleep(2000);
	}
}
