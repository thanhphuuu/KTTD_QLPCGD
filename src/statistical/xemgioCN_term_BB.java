...
public class xemgioCN_term_BB {
	public static void main(String[] args) throws InterruptedException, AWTException {
        ...
        Thread.sleep(2000);
        // Chọn xem gv thỉnh giảng
        driver.findElement(By.xpath("/html/body/div[2]/div[1]/div[2]/ul/li[5]/ul/li[4]/a")).click();
        Thread.sleep(2000);
        // Chọn xem BB
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div[2]/div[1]/div/ul/li[2]/a")).click();
        Thread.sleep(2000);
        
     // List để lưu trữ các đối tượng WebElement của thông tin thống kê
        List<WebElement> statisticElements = driver.findElements(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div[2]/div[2]/div[2]/div/div/div/table/tbody/tr/td[2] | /html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div[2]/div[2]/div[2]/div/div/div/table/tbody/tr/td[6] | /html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div[2]/div[2]/div[2]/div/div/div/table/tbody/tr/td[7]"));


        // List chứa các kết quả mong đợi
        List<String> expectedStatistics = List.of("71ITBS1010", "TH", "70");
