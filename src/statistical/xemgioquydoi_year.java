...
public class xemgioquydoi_year {
	public static void main(String[] args) throws InterruptedException, AWTException {
        ...
        Thread.sleep(2000);
        // Chọn xem số giờ quy đổi
        driver.findElement(By.xpath("/html/body/div[2]/div[1]/div[2]/ul/li[5]/ul/li[2]/a")).click();
        Thread.sleep(2000);
        // Chọn xem số giờ quy đổi theo năm
        ...
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div[1]/div[3]/div/span[2]/span/span[2]/ul/li[2]")).click();
        Thread.sleep(2000);
        //all
        driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div[1]/div[4]/div/span[1]/span[1]/span")).click();
        ...
        Thread.sleep(2000);
        // Chọn xem bảng biểu
        driver.findElement(By.id("table-tab")).click();
        Thread.sleep(2000);
        // Chọn xem chi tiết
