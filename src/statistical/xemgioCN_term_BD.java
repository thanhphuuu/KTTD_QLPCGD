...
public class xemgioCN_term_BD {
	public static void main(String[] args) throws InterruptedException, AWTException {
        ...
        Thread.sleep(2000);
        //so sánh 
        WebElement statisticElement = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[3]/div/section/div/div/div/div[2]/div[2]/div[2]/div[1]/div/canvas"));

        // Lấy nội dung thống kê
        String actualStatistic = statisticElement.getText();

        // Kết quả mong đợi
        String expectedStatistic = "Số môn học: 1/Tổng số giờ giảng 60/ Tổng số giờ quy đổi: 60";
        ...
        if (actualStatistic.equals(expectedStatistic)) {
            ...
            System.out.println("Kết quả thống kê không chính xác! ");
        }
